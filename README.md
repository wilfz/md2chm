...
On the other hand many desktop applications need documentation in form of help files. The Windows operating system contains the help file viewer hh.exe and even other OS such as Linux distrbutions provide viewers for chm (Compiled HTML Module) files.  
...
```
md2chm [-h] [-t TARGET] [--title TITLE] [--default_topic DEFAULT_TOPIC] [-w WORKDIR] [--css CSS] [-v] source
```
